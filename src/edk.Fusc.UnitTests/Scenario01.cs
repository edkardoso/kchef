...
public class Scenario01
{
    ...
    public async Task OnExecuteAsync_ShouldReturnSquareOfNumber()
    {
        ...
        // assert
        Assert.Equal(100, presenter.Output.GetValueOrDefault(0));
    }
    ...
    public async Task OnExecuteAsync_ShouldReturnZero()
    {
        ...
        // assert
        Assert.Equal(0, presenter.Output.GetValueOrDefault(-1));
    }
    ...
    public async Task OnExecuteAsync_ShouldReturnNoValue()
    {
        ...
        // assert
        Assert.Equal(NoValue.Create, presenter.Output.GetValueOrDefault(NoValue.Null));
    }
