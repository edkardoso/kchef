...
namespace edk.Kchef.Domain.Common.ValueObjects
{
    ...
    // https://github.com/vkhorikov/CSharpFunctionalExtensions/tree/master/CSharpFunctionalExtensions/ValueObject

    // Important: Optei por usar uma classe base ao invés de usar os records devido a possibilidade
    //  de se implementar comparações mais específicas no Equals quando necessário (no records sempre serão consideradas todas as propriedades)
    // e também por os records não funcionam no LINQ, por exemplo em Sort ou OrderBy
