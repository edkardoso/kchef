...
public static class EvaluateLibrary
{
    ...
    public static bool WhenIsTypeEqual<T>(this object obj,  Action actionTrue) => WhenTrue(obj.GetType() == typeof(T), actionTrue);
    ...
    public static bool WhenEmpty(this Guid obj, Action action) => WhenTrue(obj == Guid.Empty, () => action.Invoke());
    public static bool WhenNoEmpty(this Guid obj, Action action) => WhenTrue(obj != Guid.Empty, () => action.Invoke());
